...
REFINE_ROOT = ROOT / "experiments_2408_lb_refine"
...
REFINE_EXPERIMENTS = [
    {
        "version": "v12_lb62",
        "description": "Fine look-back search around the current 2408 winner with look_back=62.",
        "look_back": 62,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v13_lb63",
        "description": "Fine look-back search around the current 2408 winner with look_back=63.",
        "look_back": 63,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v14_lb67",
        "description": "Fine look-back search around the current 2408 winner with look_back=67.",
        "look_back": 67,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v15_lb68",
        "description": "Fine look-back search around the current 2408 winner with look_back=68.",
        "look_back": 68,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
        ...
        ranking.append(
            {
                ...
                "source": entry.get("source", "experiments_2408_lb_refine"),
    ...
    results = {
        ...
        "best_new_experiment": min(
            (
                {
                    "version": entry["version"],
                    "source": "experiments_2408_lb_refine",
                    "notebook": entry["notebook"],
                    "look_back": entry["config"]["look_back"],
