...
SWEEP_ROOT = ROOT / "experiments_2330_lb_sweep"
...
SWEEP_EXPERIMENTS = [
    {
        "version": "v6_lb40",
        "description": "Look-back sweep on 2330 with look_back=40.",
        "look_back": 40,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v7_lb50",
        "description": "Look-back sweep on 2330 with look_back=50.",
        "look_back": 50,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v8_lb55",
        "description": "Look-back sweep on 2330 with look_back=55.",
        "look_back": 55,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v9_lb65",
        "description": "Look-back sweep on 2330 with look_back=65.",
        "look_back": 65,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v10_lb70",
        "description": "Look-back sweep on 2330 with look_back=70.",
        "look_back": 70,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
    ...
    {
        "version": "v11_lb80",
        "description": "Look-back sweep on 2330 with look_back=80.",
        "look_back": 80,
        "hidden_sizes": [128, 64],
        "dropout": 0.0,
        "learning_rate": 0.001,
        ...
        ranking.append(
            {
                ...
                "source": entry.get("source", "experiments_2330_lb_sweep"),
